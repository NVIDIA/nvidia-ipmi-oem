...
namespace ipmi
{
    ...
    {
        phosphor::logging::log<phosphor::logging::level::ERR>("Command is unsupported on Spectre");
    ...
    ipmi::RspType<uint8_t> ipmicmdRejectCtxOneParamSpectre(ipmi::Context::ptr ctx, uint8_t p1)
    {
        phosphor::logging::log<phosphor::logging::level::ERR>("Command is unsupported on Spectre");
        return ipmi::response(ipmi::ccInvalidCommand);
    }
    ...
    ipmi::RspType<uint8_t> ipmicmdRejectCtxTwoParamSpectre(ipmi::Context::ptr ctx, uint8_t p1, uint8_t p2)
    {
        phosphor::logging::log<phosphor::logging::level::ERR>("Command is unsupported on Spectre");
        return ipmi::response(ipmi::ccInvalidCommand);
    }

    ipmi::RspType<uint8_t> ipmicmdRejectCtxThreeParamSpectre(ipmi::Context::ptr ctx, uint8_t p1, uint8_t p2, uint8_t p3)
    {
        phosphor::logging::log<phosphor::logging::level::ERR>("Command is unsupported on Spectre");
        return ipmi::response(ipmi::ccInvalidCommand);
    }
